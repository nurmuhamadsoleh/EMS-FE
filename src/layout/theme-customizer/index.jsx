...
const Themecustomizer = (props) => {
  ...
  const [sidebar_setting, setSidebar_setting] = useState(
  ...
  useEffect(() => {
    ...
    const modifyURL =
      window.location.pathname + Object.keys(defaultLayoutObj).pop();
    ...
    <Fragment>
      {/* <div className="customizer-links">
        <Nav className="flex-column nac-pills">
          ...
          <a
            className="nav-link"
            href="https://docs.pixelstrap.com/cuba/document/index.html"
          >
            <div>
              <i className="icon-settings"></i>
            </div>
                ...
                <ul className="sidebar-type layout-grid layout-types">
                  ...
                  >
                    <div className="layout-img">
                      ...
                      <h6>Energy Monitoring System</h6>
                    </div>
                  </li>
                  <li
                    className="only-body"
